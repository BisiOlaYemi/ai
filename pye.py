...
def extract_and_process_details():
    try:
        with open(output_path, 'w', newline='') as csv_file:
            ...
            csv_writer.writerow(['Product Name', 'Description', 'Product ID', 'Product URL', 'Image URL'])
                        ...
                        for line in lines:
                            ...
                            if len(parts) >= 11:
                                ...
                                if product_id not in processed_product_ids:
                                    ...
                                    image_url = next((url for url in unique_urls if url.startswith('https://lp2.hm.com')), '')
                                    ...
                                    if not should_filter:
                                        ...
                                        csv_row = [product_name, clean_text, product_id, product_url, image_url]
